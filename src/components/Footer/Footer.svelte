    ...
    <div class="flex-col md:mr-16">
      ...
      <div>
        <ul class="xs:flex md:flex-col md:flex-row justify-between pr-16 pb-16 flex-wrap font-thin" data-cursor-text="&#8599;">
          ...
          <li class="footer-item text-brand text-base md:text-xl ml-5">
            <a href="https://github.com/kaustubh03">Github</a>
          </li>
          <li class="footer-item text-brand ml-5 text-base md:text-xl">
            <a href="https://www.instagram.com/kaustubhsaxena/">Instagram</a>
          </li>
          <li class="footer-item text-brand ml-5 text-base md:text-xl">
            <a href="https://x.com/cos2b_dev">X</a>
          </li>
          <li class="footer-item text-brand ml-5 text-base md:text-xl">
            <a href="https://www.facebook.com/kaustubh.saxena3/">Facebook</a>
          </li>
          <li class="footer-item text-brand ml-5 text-base md:text-xl">PSN @recursivecurse</li>
        </ul>
      </div>
    </div>
